    ...
    <body> 
        <form action="/action_page.php">
          <div class="box">
            ...
            <input type="text" id="email" name="email" value="janedoe@gmail.com"><br><br>
          
            <label for="tel">Phone:</label><br>
            <input type="text" id="tel" name="tel" value="0123456789"><br><br>
           
            <div class="img">
              <img src="./images/panda_.png" alt="Panda" style="width:115%; height:120%">
            </div>
